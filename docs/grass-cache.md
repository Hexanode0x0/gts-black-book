...
Grass is generated per cell. To see which cell you are in, open the console and hit Tab to switch to the cell view. You'll see cell coordinates there. To easily view cell borders, you can install the [Debug Menu](https://www.nexusmods.com/skyrimspecialedition/mods/136456) mod.
