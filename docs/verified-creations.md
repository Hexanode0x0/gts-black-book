...
When installing Unofficial Patches, do not select any option for Whiterun. The provided GTS patch covers the city fully. Other options are still relevant.
